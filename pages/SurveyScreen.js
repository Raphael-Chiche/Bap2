...
const SurveyScreen = ({navigation}) => {
    ...
    const handleVote = (surveyId, vote) => {
      setVotes((prevVotes) => ({
        ...prevVotes,
        [surveyId]: vote,
      }));
    ...
    const renderVoteButtons = (surveyId) => (
      <View style={styles.voteContainer}>
        <TouchableOpacity
          onPress={() => handleVote(surveyId, "yes")}
          disabled={votes[surveyId] !== null}
          style={[
            styles.voteButton,
            votes[surveyId] === "yes" && styles.voteButtonSelected,
          ]}
        >
          <Text style={styles.voteText}>Oui</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => handleVote(surveyId, "no")}
          disabled={votes[surveyId] !== null}
          style={[
            styles.voteButton,
            votes[surveyId] === "no" && styles.voteButtonSelected,
          ]}
        >
